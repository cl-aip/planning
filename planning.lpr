...
(define-project :name :planning
  :modules (list (make-instance 'module :name "utils/callcc.lisp")
                 (make-instance 'module :name "utils/utilities.lisp")
                 (make-instance 'module :name "fol/infix.lisp")
                 (make-instance 'module :name "fol/unify.lisp")
                 (make-instance 'module :name "fol/normal.lisp")
                 (make-instance 'module :name "fol/fol.lisp")
                 (make-instance 'module :name "plan/statespace.lisp")
                 (make-instance 'module :name "plan/operator.lisp")
                 (make-instance 'module :name "plan/FrwdBkwd.lisp")
                 (make-instance 'module :name "plan/STRIPS.lisp")
                 (make-instance 'module :name "plan/planspace.lisp")
                 (make-instance 'module :name "plan/PSP.lisp")
                 (make-instance 'module :name "plan/STN.lisp")
                 (make-instance 'module :name "RusselProblem.lisp")
                 (make-instance 'module :name "Travel.lisp"))
  :projects nil
  :libraries nil
  :editable-files nil
