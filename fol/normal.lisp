...
(cl:defpackage :fol  ; by Seiji
  ...
  (:export ->cnf logic renaming? +fail+ +no-bindings+)
  )
...
(defvar *skolemization-counter* 0)

(defun skolem-constant (name)
  "Return a unique skolem constant, a symbol starting with '$'."
  (intern (format nil "$~A_~D" name (incf *skolemization-counter*))))
